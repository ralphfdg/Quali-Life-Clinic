...
$this->breadcrumbs=array(
    ...
    'Create Birth History',
);
?>

<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Create Birth History: <span class="text-primary"><?php echo CHtml::encode($patientName); ?></span></h1>
    <div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 border-left-primary">
        <h6 class="m-0 font-weight-bold text-primary">New Birth History Record</h6>
    </div>
    <div class="card-body">
