...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Create Immunization Record: <span class="text-success"><?php echo CHtml::encode($patientName); ?></span></h1>
    <div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 border-left-success">
        <h6 class="m-0 font-weight-bold text-success">New Immunization Record Entry</h6>
    </div>
    <div class="card-body">
