...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Update Immunization Record: <span class="text-warning"><?php echo CHtml::encode($patientName); ?></span></h1>
    <div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 border-left-warning">
        <h6 class="m-0 font-weight-bold text-warning">Edit Immunization Record #<?php echo $model->id; ?></h6>
    </div>
    <div class="card-body">
