...
class AppointmentController extends Controller
{
	...
	{
		return array(
			// Allow Patients to Book and View specific appointments
			array('allow',
				'actions'=>array('book', 'myAppointments', 'view', 'create'), // We will create 'book' and 'myAppointments' later
				'expression'=>array($this, 'isPatient'),
			),
			// Allow Doctors to View and Update Status
			array('allow',
				'actions'=>array('index', 'view', 'updateStatus', 'myQueue'),
				'expression'=>array($this, 'isDoctor'),
			),
			// Allow Admins/Super Admins to do everything
			array('allow',
